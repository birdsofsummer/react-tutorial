// @ts-nocheck
/**
 * Base on https://github.com/umijs//q/web/code/js/react/editor/node_modules/_umi-request@1.3.5@umi-request
 */
import {
  extend,
  Context,
  ...
  RequestInterceptor,
  ResponseInterceptor,
} from '/q/web/code/js/react/editor/node_modules/_umi-request@1.3.5@umi-request';
// @ts-ignore
...
import useUmiRequest, { UseRequestProvider } from '/q/web/code/js/react/editor/node_modules/_@ahooksjs_use-request@2.4.0@@ahooksjs/use-request';
import {
  BaseOptions,
  ...
  PaginatedParams,
  PaginatedResult,
} from '/q/web/code/js/react/editor/node_modules/_@ahooksjs_use-request@2.4.0@@ahooksjs/use-request/lib/types';
